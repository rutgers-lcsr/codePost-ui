...
const Highlight = (props: IHighlightProps) => {
  ...
  let onClick;
  if (commandPressed) {
    style = { cursor: 'pointer', backgroundColor: consoleTheme.highlight, opacity: consoleTheme.highlightOpacity };
    ...
    style = { cursor: 'auto', backgroundColor: consoleTheme.highlight, opacity: consoleTheme.highlightOpacity };
    CodePanelHighlighting.darkenHighlight(props.commentID, consoleTheme.highlight);
  }
