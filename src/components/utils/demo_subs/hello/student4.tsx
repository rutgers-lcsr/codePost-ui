    ...
    files: [
      {
        ...
        comments: [
          {
            text:
              "Interesting approach! Storing values in variables (and avoiding magic numbers) is a good practice. In this case, it's fine to just print the string, but this intuition will serve you well as programs become more complex.",
            startChar: 8,
            endChar: 39,
            startLine: 17,
            endLine: 17,
