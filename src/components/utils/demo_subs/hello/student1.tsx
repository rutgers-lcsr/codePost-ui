    ...
    files: [
      {
        ...
        comments: [
          ...
          {
            text:
              "This program is really simple, so it's fine that you didn't comment anything. That said, when your programs become more complex, comments will be crucial for helping others (like me!) understand your code.",
            startChar: 4,
            endChar: 44,
            startLine: 14,
            endLine: 14,
