    ...
    files: [
      {
        ...
        comments: [
          ...
          {
            text: "Comments that describe simple statements like print are unnecessary -- it's usually better to let your code speak for itself. That said, when your code becomes more complex, comments will be crucial, so your intuition will serve you well in future weeks.",
            startChar: 8,
            endChar: 25,
            startLine: 16,
            endLine: 16,
