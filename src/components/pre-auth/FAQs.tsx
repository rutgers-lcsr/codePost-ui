...
const apiFAQ = (
  <div style={questionStyle}>
    ...
    <br />
    <span>
      The codePost API is a <a href="https://en.wikipedia.org/wiki/Representational_state_transfer">RESTful API</a> that
...
const autograderFAQ = (
  <div style={questionStyle}>
    ...
    <br />
    <span>
      Using the codePost API, you can send submissions to an autograder for evaluation, and then send autograding output
      (e.g., a <Typography.Text code>.txt</Typography.Text> file listing the tests a student passed and failed) to
      codePost. Graders can view and annotate this file during code review, and students can see it as part of their
      graded submission when feedback is published.
    </span>
    <br />
    <br />
    <span>
      You can take this one step further by automatically parsing autograder output, and using the codePost API to make
      deductions to a student's grade based on failed or passed tests.
    </span>
  </div>
);
...
const dontreviewFAQ = (
  <div style={questionStyle}>
    ...
    <br />
    <span>
      If you don't want to do code review, you can still make use of codePost's course management functionality and API.
      Though we don't think of codePost as an LMS, some of our users have replaced their LMS with codePost.
    </span>
  </div>
);
