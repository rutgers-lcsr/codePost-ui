...
const SimpleGradeMenu = (props: {
  selectedKeys: string[];
  secondFileDeduction: any;
}) => {
  ...
  return (
    <div className='SimpleGradeMenu' style={{ height: 530 }}>
      <div style={{ padding: '13px 20px 0px 16px' }}>
        <div
          className='cp-label cp-label--plus cp-label--bold'
