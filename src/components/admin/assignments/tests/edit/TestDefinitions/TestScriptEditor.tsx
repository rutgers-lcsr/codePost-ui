...
export const TestScriptEditor = (props: IProps) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: '900px' }}>
      {/* Toolbar */}
      <div
        style={{
          marginBottom: 10,
      ...
      >
        ...
        {error && <Alert type="error" title={error} banner style={{ marginLeft: 'auto' }} />}
      </div>
