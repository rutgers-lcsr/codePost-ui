...
export interface IMarkdownCommentListProps {
  file: FileType;
...
interface IMarkdownCommentListState {
  placeholder: number;
  isMounted: boolean;
}
...
class MarkdownCommentList extends React.Component<IMarkdownCommentListProps, IMarkdownCommentListState> {
  public state: Readonly<IMarkdownCommentListState> = {
    placeholder: 0,
    isMounted: false,
  };
  ...
  public getCommentNodes = (comments: CommentType[]) => {
    ...
    return comments.map((comment: CommentType) => {
      ...
      // let startAt = 10;
      let startAt = comment.startLine * 20; // estimate
...
export default MarkdownCommentList;
