...
const OrgSettings: React.FC<IProps> = (props) => {
            ...
            case 'GOOGLE':
                return (
                    <>
                        ...
                        <Form.Item name="hosted_domain" label="Hosted Domain (Optional)" help="Restrict login to a specific domain (e.g. university.edu)">
    ...
    return (
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '24px 0' }}>
            ...
            >
                <div style={{ marginBottom: 24, border: '1px solid #f0f0f0', padding: 24, borderRadius: 8, background: '#fff' }}>
