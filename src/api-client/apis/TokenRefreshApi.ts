...
export class TokenRefreshApi extends runtime.BaseAPI {
     ...
     */
    async createRaw(requestParameters: CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TokenRefreshSliding>> {
     ...
     * Takes a sliding JSON web token and returns a new, refreshed version if the token\'s refresh period has not expired.
     */
    async create(requestParameters: CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TokenRefreshSliding> {
