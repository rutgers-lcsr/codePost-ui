...
import type { LearningObjective, PatchedLearningObjective } from '../models/index';

export interface CreateRequest {
  learningObjective: Omit<LearningObjective, 'id' | 'testCases'>;
}
...
export interface PartialUpdateRequest {
  id: number;
  patchedLearningObjective?: Omit<PatchedLearningObjective, 'id' | 'testCases'>;
}
 ...
 *
 */
export class LearningObjectivesApi extends runtime.BaseAPI {
  /**
  ...
  async createRaw(
  ...
  ): Promise<runtime.ApiResponse<LearningObjective>> {
    if (requestParameters['learningObjective'] == null) {
      throw new runtime.RequiredError(
        'learningObjective',
        'Required parameter "learningObjective" was null or undefined when calling create().',
      );
    }
    ...
    let urlPath = `/learningObjectives/`;
    ...
    const response = await this.request(
      {
        ...
        body: requestParameters['learningObjective'],
      },
      initOverrides,
    );
  ...
  async destroyRaw(
    ...
    let urlPath = `/learningObjectives/{id}/`;
   ...
   * list: Return a list of all the learningObjectives.  create: Create a new learningObjective.  retrieve: Return the given learningObjective.  update: Update a learningObjective.  partial_update: Update a learningObjective.  delete: Delete a learningObjective.
   */
  async list(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<LearningObjective>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: requestParameters['patchedLearningObjective'],
      },
      initOverrides,
    );
  ...
  async updateRaw(
    ...
    if (requestParameters['learningObjective'] == null) {
      throw new runtime.RequiredError(
        'learningObjective',
        'Required parameter "learningObjective" was null or undefined when calling update().',
      );
    }
