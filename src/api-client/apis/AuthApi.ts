...
export class AuthApi extends runtime.BaseAPI {
     ...
     */
    async ssoCallbackRetrieveRaw(requestParameters: SsoCallbackRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * Handles the callback from the SSO provider. Validates ticket/code, creates session, redirects to frontend.
     */
    async ssoCallbackRetrieve(requestParameters: SsoCallbackRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     */
    async ssoCheckRetrieveRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CheckSSOAvailabilityResponse>> {
        const queryParameters: any = {};
     ...
     * Checks if the given email belongs to an SSO-enabled organization. Returns { \"sso_enabled\": true, \"provider\": \"CAS\", \"org_id\": 123 } or { \"sso_enabled\": false }
     */
    async ssoCheckRetrieve(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CheckSSOAvailabilityResponse> {
     ...
     */
    async ssoLoginRetrieveRaw(requestParameters: SsoLoginRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['provider'] == null) {
            throw new runtime.RequiredError(
                'provider',
     ...
     * Redirects user to the SSO provider\'s login page. Requires \'email\' query param to identify the organization (and thus the config), OR \'org\' ID directly.
     */
    async ssoLoginRetrieve(requestParameters: SsoLoginRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
