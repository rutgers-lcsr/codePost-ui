...
export interface QuizGradingProgressRetrieveRequest {
  id: number;
}
...
export class CoursesApi extends runtime.BaseAPI {
   ...
   */
  async questionBanksListRaw(
    requestParameters: QuestionBanksListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<QuestionBank>>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter "id" was null or undefined when calling questionBanksList().',
      );
    }
    ...
    let urlPath = `/courses/{id}/questionBanks/`;
    urlPath = urlPath.replace(`{${'id'}}`, encodeURIComponent(String(requestParameters['id'])));
   ...
   * List the course\'s quiz question banks (staff only).
   */
  async questionBanksList(
    requestParameters: QuestionBanksListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<QuestionBank>> {
    const response = await this.questionBanksListRaw(requestParameters, initOverrides);
    return await response.value();
  }
   ...
   */
  async quizGradingProgressRetrieveRaw(
    requestParameters: QuizGradingProgressRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<QuizGradingProgress>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter "id" was null or undefined when calling quizGradingProgressRetrieve().',
      );
    }
    ...
    let urlPath = `/courses/{id}/quizGradingProgress/`;
    urlPath = urlPath.replace(`{${'id'}}`, encodeURIComponent(String(requestParameters['id'])));
   ...
   * Per-grader manual quiz-grading progress across the course\'s published quizzes (submitted attempts only). perQuiz keys are quiz ids; graders who left the course keep their rows (accountability, not a roster).
   */
  async quizGradingProgressRetrieve(
    requestParameters: QuizGradingProgressRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<QuizGradingProgress> {
    const response = await this.quizGradingProgressRetrieveRaw(requestParameters, initOverrides);
    return await response.value();
  }
  ...
  async quizzesListRaw(
    ...
    let urlPath = `/courses/{id}/quizzes/`;
    urlPath = urlPath.replace(`{${'id'}}`, encodeURIComponent(String(requestParameters['id'])));
