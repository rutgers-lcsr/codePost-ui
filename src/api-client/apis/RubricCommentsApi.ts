...
import type { PatchedRubricComment, RubricComment } from '../models/index';
...
export class RubricCommentsApi extends runtime.BaseAPI {
   ...
   */
  async commentsRetrieveRaw(
    requestParameters: CommentsRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<RubricComment>> {
   ...
   * list: Return a list of all the rubric comments.  create: Create a new rubric comment.  retrieve: Return the given rubric comment.  update: Update a rubric comment.  partial_update: Update a rubric comment.  delete: Delete a rubric comment.
   */
  async feedbackScoreRetrieveRaw(
    requestParameters: FeedbackScoreRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<RubricComment>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
  ...
  async listRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<RubricComment>>> {
    const queryParameters: any = {};
