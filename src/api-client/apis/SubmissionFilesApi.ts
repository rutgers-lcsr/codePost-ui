...
import type { PatchedSubmissionFile, SubmissionFile } from '../models/index';

export interface CreateRequest {
  submissionFile: Omit<SubmissionFile, 'id' | 'comments' | 'created' | 'modified' | 'edit'>;
}
...
export interface PartialUpdateRequest {
  id: number;
  patchedSubmissionFile?: Omit<PatchedSubmissionFile, 'id' | 'comments' | 'created' | 'modified' | 'edit'>;
}
...
export class SubmissionFilesApi extends runtime.BaseAPI {
  ...
  ): Promise<runtime.ApiResponse<SubmissionFile>> {
  ...
  async listRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<SubmissionFile>>> {
    const queryParameters: any = {};
