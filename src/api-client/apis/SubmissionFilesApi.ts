...
export interface CreateRequest {
    submissionFile: Omit<SubmissionFile, 'id'|'comments'|'created'|'modified'>;
}
...
export interface PartialUpdateRequest {
    id: number;
    patchedSubmissionFile?: Omit<PatchedSubmissionFile, 'id'|'comments'|'created'|'modified'>;
}
 ...
 * 
 */
export class SubmissionFilesApi extends runtime.BaseAPI {
     ...
     */
    async createRaw(requestParameters: CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmissionFile>> {
        if (requestParameters['submissionFile'] == null) {
            throw new runtime.RequiredError(
                'submissionFile',
                'Required parameter "submissionFile" was null or undefined when calling create().'
            );
        }
        ...
        const response = await this.request({
            ...
            body: requestParameters['submissionFile'],
        }, initOverrides);
     ...
     * ViewSet for SubmissionFile objects.  SubmissionFiles are files that belong to student submissions. These were previously just called \"File\" objects.  list: Return a list of all submission files.  create: Create a new submission file.  retrieve: Return the given submission file.  update: Update a submission file.  partial_update: Partially update a submission file.  delete: Delete a submission file.
     */
    async create(requestParameters: CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmissionFile> {
    ...
    async destroyRaw(requestParameters: DestroyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        let urlPath = `/submissionFiles/{id}/`;
     ...
     * ViewSet for SubmissionFile objects.  SubmissionFiles are files that belong to student submissions. These were previously just called \"File\" objects.  list: Return a list of all submission files.  create: Create a new submission file.  retrieve: Return the given submission file.  update: Update a submission file.  partial_update: Partially update a submission file.  delete: Delete a submission file.
     */
    async listRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SubmissionFile>>> {
        const queryParameters: any = {};
     ...
     * ViewSet for SubmissionFile objects.  SubmissionFiles are files that belong to student submissions. These were previously just called \"File\" objects.  list: Return a list of all submission files.  create: Create a new submission file.  retrieve: Return the given submission file.  update: Update a submission file.  partial_update: Partially update a submission file.  delete: Delete a submission file.
     */
    async list(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SubmissionFile>> {
     ...
     * ViewSet for SubmissionFile objects.  SubmissionFiles are files that belong to student submissions. These were previously just called \"File\" objects.  list: Return a list of all submission files.  create: Create a new submission file.  retrieve: Return the given submission file.  update: Update a submission file.  partial_update: Partially update a submission file.  delete: Delete a submission file.
     */
    async partialUpdateRaw(requestParameters: PartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmissionFile>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters['patchedSubmissionFile'],
        }, initOverrides);
     ...
     * ViewSet for SubmissionFile objects.  SubmissionFiles are files that belong to student submissions. These were previously just called \"File\" objects.  list: Return a list of all submission files.  create: Create a new submission file.  retrieve: Return the given submission file.  update: Update a submission file.  partial_update: Partially update a submission file.  delete: Delete a submission file.
     */
    async partialUpdate(requestParameters: PartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmissionFile> {
     ...
     * ViewSet for SubmissionFile objects.  SubmissionFiles are files that belong to student submissions. These were previously just called \"File\" objects.  list: Return a list of all submission files.  create: Create a new submission file.  retrieve: Return the given submission file.  update: Update a submission file.  partial_update: Partially update a submission file.  delete: Delete a submission file.
     */
    async retrieveRaw(requestParameters: RetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmissionFile>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * ViewSet for SubmissionFile objects.  SubmissionFiles are files that belong to student submissions. These were previously just called \"File\" objects.  list: Return a list of all submission files.  create: Create a new submission file.  retrieve: Return the given submission file.  update: Update a submission file.  partial_update: Partially update a submission file.  delete: Delete a submission file.
     */
    async retrieve(requestParameters: RetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmissionFile> {
     ...
     * ViewSet for SubmissionFile objects.  SubmissionFiles are files that belong to student submissions. These were previously just called \"File\" objects.  list: Return a list of all submission files.  create: Create a new submission file.  retrieve: Return the given submission file.  update: Update a submission file.  partial_update: Partially update a submission file.  delete: Delete a submission file.
     */
    async updateRaw(requestParameters: UpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmissionFile>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        if (requestParameters['submissionFile'] == null) {
            throw new runtime.RequiredError(
                'submissionFile',
                'Required parameter "submissionFile" was null or undefined when calling update().'
            );
        }
     ...
     * ViewSet for SubmissionFile objects.  SubmissionFiles are files that belong to student submissions. These were previously just called \"File\" objects.  list: Return a list of all submission files.  create: Create a new submission file.  retrieve: Return the given submission file.  update: Update a submission file.  partial_update: Partially update a submission file.  delete: Delete a submission file.
     */
    async update(requestParameters: UpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmissionFile> {
