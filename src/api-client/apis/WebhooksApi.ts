...
export interface CreateRequest {
    webhook: Omit<Webhook, 'id'|'last_triggered_at'|'last_triggered_status'>;
}
...
export interface PartialUpdateRequest {
    id: number;
    patchedWebhook?: Omit<PatchedWebhook, 'id'|'last_triggered_at'|'last_triggered_status'>;
}
...
export class WebhooksApi extends runtime.BaseAPI {
    ...
    async createRaw(requestParameters: CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Webhook>> {
        if (requestParameters['webhook'] == null) {
            throw new runtime.RequiredError(
                'webhook',
                'Required parameter "webhook" was null or undefined when calling create().'
            );
        }
        ...
        const response = await this.request({
            ...
            body: requestParameters['webhook'],
        }, initOverrides);
    ...
    /**
     */
    async listRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Webhook>>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async list(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Webhook>> {
    ...
    /**
     */
    async partialUpdateRaw(requestParameters: PartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Webhook>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters['patchedWebhook'],
        }, initOverrides);
    ...
    /**
     */
    async partialUpdate(requestParameters: PartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Webhook> {
    ...
    async updateRaw(requestParameters: UpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Webhook>> {
        ...
        if (requestParameters['webhook'] == null) {
            throw new runtime.RequiredError(
                'webhook',
                'Required parameter "webhook" was null or undefined when calling update().'
            );
        }
