...
import type { PatchedRubricCategory, RubricCategory } from '../models/index';
...
export class RubricCategoriesApi extends runtime.BaseAPI {
  ...
  ): Promise<runtime.ApiResponse<RubricCategory>> {
  ...
  async listRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<RubricCategory>>> {
    const queryParameters: any = {};
