...
export class AdminApi extends runtime.BaseAPI {
   ...
   */
  async retrieveRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
   ...
   * A simple ViewSet that redirects to the admin interface.
   */
  async retrieve(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
    await this.retrieveRaw(initOverrides);
  }
}
