...
export class FilesApi extends runtime.BaseAPI {
     ...
     */
    async createRaw(requestParameters: CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * ViewSet for base File objects.  This handles all file types polymorphically. For specific file types, use the dedicated endpoints: - /submissionFiles/ for SubmissionFile objects - /assignmentFiles/ for AssignmentFile objects - /courseFiles/ for CourseFile objects  list: Return a list of all files (all types).  create: Create a new file.  retrieve: Return the given file.  update: Update a file.  partial_update: Partially update a file.  delete: Delete a file.
     */
    async create(requestParameters: CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * ViewSet for base File objects.  This handles all file types polymorphically. For specific file types, use the dedicated endpoints: - /submissionFiles/ for SubmissionFile objects - /assignmentFiles/ for AssignmentFile objects - /courseFiles/ for CourseFile objects  list: Return a list of all files (all types).  create: Create a new file.  retrieve: Return the given file.  update: Update a file.  partial_update: Partially update a file.  delete: Delete a file.
     */
    async partialUpdateRaw(requestParameters: PartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * ViewSet for base File objects.  This handles all file types polymorphically. For specific file types, use the dedicated endpoints: - /submissionFiles/ for SubmissionFile objects - /assignmentFiles/ for AssignmentFile objects - /courseFiles/ for CourseFile objects  list: Return a list of all files (all types).  create: Create a new file.  retrieve: Return the given file.  update: Update a file.  partial_update: Partially update a file.  delete: Delete a file.
     */
    async partialUpdate(requestParameters: PartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * ViewSet for base File objects.  This handles all file types polymorphically. For specific file types, use the dedicated endpoints: - /submissionFiles/ for SubmissionFile objects - /assignmentFiles/ for AssignmentFile objects - /courseFiles/ for CourseFile objects  list: Return a list of all files (all types).  create: Create a new file.  retrieve: Return the given file.  update: Update a file.  partial_update: Partially update a file.  delete: Delete a file.
     */
    async retrieveRaw(requestParameters: RetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * ViewSet for base File objects.  This handles all file types polymorphically. For specific file types, use the dedicated endpoints: - /submissionFiles/ for SubmissionFile objects - /assignmentFiles/ for AssignmentFile objects - /courseFiles/ for CourseFile objects  list: Return a list of all files (all types).  create: Create a new file.  retrieve: Return the given file.  update: Update a file.  partial_update: Partially update a file.  delete: Delete a file.
     */
    async retrieve(requestParameters: RetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
