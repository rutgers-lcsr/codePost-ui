...
export class DashboardApi extends runtime.BaseAPI {
  ...
  async autogradingStatsRetrieveRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AutogradingStats>> {
    const queryParameters: any = {};
    ...
    let urlPath = `/dashboard/autograding_stats/`;
  ...
  async autogradingStatsRetrieve(
    requestParameters: AutogradingStatsRetrieveRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<AutogradingStats> {
    const response = await this.autogradingStatsRetrieveRaw(requestParameters, initOverrides);
    return await response.value();
  }
