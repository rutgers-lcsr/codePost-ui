...
export interface PartialUpdateRequest {
  id: number;
  patchedSuggestedQuizQuestion?: Omit<
    PatchedSuggestedQuizQuestion,
    | 'id'
    | 'assignment'
    | 'sourceQuestion'
 ...
 *
 */
export class SuggestedQuizQuestionsApi extends runtime.BaseAPI {
  /**
  ...
  async acceptCreateRaw(
    ...
    let urlPath = `/suggestedQuizQuestions/{id}/accept/`;
    ...
    const response = await this.request(
      {
        ...
        body: requestParameters['acceptSuggestionRequest'],
      },
      initOverrides,
    );
  ...
  async createRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SuggestedQuizQuestion>> {
    if (requestParameters['suggestedQuizQuestion'] == null) {
      throw new runtime.RequiredError(
        'suggestedQuizQuestion',
        'Required parameter "suggestedQuizQuestion" was null or undefined when calling create().',
      );
    }
    ...
    let urlPath = `/suggestedQuizQuestions/`;
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: requestParameters['suggestedQuizQuestion'],
      },
      initOverrides,
    );
  ...
  async destroyRaw(
    ...
    let urlPath = `/suggestedQuizQuestions/{id}/`;
    urlPath = urlPath.replace(`{${'id'}}`, encodeURIComponent(String(requestParameters['id'])));
   ...
   * AI-suggested quiz questions for instructors. Staff-only.  A pending suggestion can be edited (PATCH) and then accepted into a real, editable Question (authored by the instructor) or rejected.
   */
  async list(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SuggestedQuizQuestion>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: requestParameters['patchedSuggestedQuizQuestion'],
      },
      initOverrides,
    );
  ...
  async rejectCreateRaw(
    ...
    let urlPath = `/suggestedQuizQuestions/{id}/reject/`;
    urlPath = urlPath.replace(`{${'id'}}`, encodeURIComponent(String(requestParameters['id'])));
  ...
  async updateRaw(
    ...
    if (requestParameters['suggestedQuizQuestion'] == null) {
      throw new runtime.RequiredError(
        'suggestedQuizQuestion',
        'Required parameter "suggestedQuizQuestion" was null or undefined when calling update().',
      );
    }
