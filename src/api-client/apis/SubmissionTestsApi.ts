 ...
 * 
 */
export class SubmissionTestsApi extends runtime.BaseAPI {
     ...
     */
    async createRaw(requestParameters: CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmissionTest>> {
        if (requestParameters['submissionTest'] == null) {
            throw new runtime.RequiredError(
                'submissionTest',
                'Required parameter "submissionTest" was null or undefined when calling create().'
            );
        }
        ...
        const response = await this.request({
            ...
            body: requestParameters['submissionTest'],
        }, initOverrides);
     ...
     * list: Return a list of all the solutionFiles.  create: Create a new solutionFiles.  retrieve: Return the given solutionFiles.  update: Update a solutionFiles.  partial_update: Update a solutionFiles.  delete: Delete a solutionFiles.
     */
    async create(requestParameters: CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmissionTest> {
    ...
    async destroyRaw(requestParameters: DestroyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        let urlPath = `/submissionTests/{id}/`;
     ...
     * list: Return a list of all the solutionFiles.  create: Create a new solutionFiles.  retrieve: Return the given solutionFiles.  update: Update a solutionFiles.  partial_update: Update a solutionFiles.  delete: Delete a solutionFiles.
     */
    async listRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SubmissionTest>>> {
        const queryParameters: any = {};
     ...
     * list: Return a list of all the solutionFiles.  create: Create a new solutionFiles.  retrieve: Return the given solutionFiles.  update: Update a solutionFiles.  partial_update: Update a solutionFiles.  delete: Delete a solutionFiles.
     */
    async list(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SubmissionTest>> {
     ...
     * list: Return a list of all the solutionFiles.  create: Create a new solutionFiles.  retrieve: Return the given solutionFiles.  update: Update a solutionFiles.  partial_update: Update a solutionFiles.  delete: Delete a solutionFiles.
     */
    async partialUpdateRaw(requestParameters: PartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmissionTest>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters['patchedSubmissionTest'],
        }, initOverrides);
     ...
     * list: Return a list of all the solutionFiles.  create: Create a new solutionFiles.  retrieve: Return the given solutionFiles.  update: Update a solutionFiles.  partial_update: Update a solutionFiles.  delete: Delete a solutionFiles.
     */
    async partialUpdate(requestParameters: PartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmissionTest> {
     ...
     * list: Return a list of all the solutionFiles.  create: Create a new solutionFiles.  retrieve: Return the given solutionFiles.  update: Update a solutionFiles.  partial_update: Update a solutionFiles.  delete: Delete a solutionFiles.
     */
    async retrieveRaw(requestParameters: RetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmissionTest>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * list: Return a list of all the solutionFiles.  create: Create a new solutionFiles.  retrieve: Return the given solutionFiles.  update: Update a solutionFiles.  partial_update: Update a solutionFiles.  delete: Delete a solutionFiles.
     */
    async retrieve(requestParameters: RetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmissionTest> {
     ...
     * list: Return a list of all the solutionFiles.  create: Create a new solutionFiles.  retrieve: Return the given solutionFiles.  update: Update a solutionFiles.  partial_update: Update a solutionFiles.  delete: Delete a solutionFiles.
     */
    async updateRaw(requestParameters: UpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmissionTest>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        if (requestParameters['submissionTest'] == null) {
            throw new runtime.RequiredError(
                'submissionTest',
                'Required parameter "submissionTest" was null or undefined when calling update().'
            );
        }
     ...
     * list: Return a list of all the solutionFiles.  create: Create a new solutionFiles.  retrieve: Return the given solutionFiles.  update: Update a solutionFiles.  partial_update: Update a solutionFiles.  delete: Delete a solutionFiles.
     */
    async update(requestParameters: UpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmissionTest> {
