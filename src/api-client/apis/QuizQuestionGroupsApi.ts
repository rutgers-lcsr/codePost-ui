...
import type { PatchedQuizQuestionGroup, QuizQuestionGroup } from '../models/index';

export interface CreateRequest {
  quizQuestionGroup: Omit<QuizQuestionGroup, 'id'>;
}
...
export interface PartialUpdateRequest {
  id: number;
  patchedQuizQuestionGroup?: Omit<PatchedQuizQuestionGroup, 'id'>;
}
 ...
 *
 */
export class QuizQuestionGroupsApi extends runtime.BaseAPI {
  /**
  ...
  async createRaw(
  ...
  ): Promise<runtime.ApiResponse<QuizQuestionGroup>> {
    if (requestParameters['quizQuestionGroup'] == null) {
      throw new runtime.RequiredError(
        'quizQuestionGroup',
        'Required parameter "quizQuestionGroup" was null or undefined when calling create().',
      );
    }
    ...
    let urlPath = `/quizQuestionGroups/`;
    ...
    const response = await this.request(
      {
        ...
        body: requestParameters['quizQuestionGroup'],
      },
      initOverrides,
    );
  ...
  async destroyRaw(
    ...
    let urlPath = `/quizQuestionGroups/{id}/`;
  ...
  async listRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<QuizQuestionGroup>>> {
    const queryParameters: any = {};
   ...
   * Random-draw groups on a quiz: pick N random questions from a bank, P points each. POST to add (with quiz + bank + pickCount + pointsPerQuestion), PATCH to edit, DELETE to remove.
   */
  async list(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<QuizQuestionGroup>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: requestParameters['patchedQuizQuestionGroup'],
      },
      initOverrides,
    );
  ...
  async updateRaw(
    ...
    if (requestParameters['quizQuestionGroup'] == null) {
      throw new runtime.RequiredError(
        'quizQuestionGroup',
        'Required parameter "quizQuestionGroup" was null or undefined when calling update().',
      );
    }
