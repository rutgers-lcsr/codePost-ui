...
import type { EmailCreateRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // User
    user: ...,
  } satisfies EmailCreateRequest;

  try {
    const data = await api.emailCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { MePartialUpdateRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    patchedUser: ...,
  } satisfies MePartialUpdateRequest;

  try {
    const data = await api.mePartialUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
async function example() {
  ...
  try {
    const data = await api.meRetrieve();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { RequestAPITokenCreateRequest } from '';
...
async function example() {
  ...
  const body = {
    // User
    user: ...,
  } satisfies RequestAPITokenCreateRequest;

  try {
    const data = await api.requestAPITokenCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
