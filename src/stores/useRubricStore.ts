    ...
    devtools(
        (set, get) => ({
            ...
            onCategoryEdit: (category) => {
                ...
                }), false, 'onCategoryEdit');
            },

            onCategoryUndo: (category) => {
                set(state => ({
                    unsavedCategories: state.unsavedCategories.filter(c => c.id !== category.id),
                }), false, 'onCategoryUndo');
            },
            ...
            setConfirmedPropagation: (confirmed) => set({ confirmedPropagation: confirmed }, false, 'setConfirmedPropagation'),
