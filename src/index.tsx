...
const maintenanceBanner = (
  ...
  >
    The codePost autograder test runner is currently experiencing technical difficulties. Some test runs may not complete. We're working hard to get it back working.
  </div>
);
