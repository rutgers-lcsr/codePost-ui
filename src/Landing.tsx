      ...
      <div className="Landing">
          ...
          <div className="diagram col-md-8">
            ...
            <div className="grader-student row">
              ...
              <div className="grader col-md-6">
                <div className="title">Graders</div>
                <div className="text">
        ...
        <div className="oldFlow">
          <div className="problems col-md-8">
            ...
            <div className="admin row">
              <div className="title col-md-3"> Administrators</div>
              <div className="icons col-md-3">
                <img className="admin-icon" src={require('./img/admin_old.png')} />
              </div>
              <div className="text col-md-5">
                <div className="bullet row">
                  <b>No visibility</b> on data and trends.
                </div>
                <div className="bullet row">
                  <b>Time-intensive</b> manual processes.
                </div>
                <div className="bullet row">Bullet 3</div>
              </div>
            </div>
            <div className="grader row">
              <div className="title col-md-3"> Graders</div>
              <div className="icons col-md-3">
                <img className="grader-icon" src={require('./img/grader_old.png')} />
              </div>
              <div className="text col-md-6">
                <div className="bullet row">
                  <b>Unstructured</b> feedback to students.
                </div>
                <div className="bullet row">
                  <b>Paper-based</b>.
                </div>
            ...
            <div className="student row">
              <div className="title col-md-3"> Students</div>
              <div className="icons col-md-3">
                <img className="student-icon" src={require('./img/student_old.png')} />
              </div>
              <div className="text col-md-6">
                <div className="bullet row">
                  <b>Difficult to understand</b> hand-written comments.
                </div>
                <div className="bullet row">
                  <b>Easy to lose</b> feedback.
                </div>
                <div className="bullet row">Bullet 3</div>
              </div>
            </div>
          ...
          <div className="CP-headline col-md-4">
            <div className="bullet-bold">codePost just works, so you don't have to</div>
          </div>
        </div>
        <div className="buffer" />
        <div className="siteVideos">
          ...
          <div className="videos col-md-8">
            <video
              ...
              muted={true}
              preload="auto"
              src={this.vidTypes[this.state.active]}
            />
          </div>
        </div>
        <div className="buffer" />
